...
local plugins = lush(function()
	return {
		...
		-- gitsigns.nvim
		GitSignsAdd({ base.GruvboxGreenSignTransparent }),
		GitSignsChange({ base.GruvboxAquaSignTransparent }),
		GitSignsDelete({ base.GruvboxRedSignTransparent }),
